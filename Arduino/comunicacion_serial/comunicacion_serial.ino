...
void loop() {
  if (Serial.available() > 0) {
    ...
    int i0 = datos.indexOf("q0:");
    int i1 = datos.indexOf("q1:");
    int i2 = datos.indexOf("q2:");

    if (i0 != -1 && i1 != -1 && i2 != -1) {
      float q0 = datos.substring(i0 + 3, datos.indexOf(',', i0)).toFloat();
      int q1 = datos.substring(i1 + 3, datos.indexOf(',', i1)).toInt();
      String q2 = datos.substring(i2 + 3);

      Serial.print("Recibido -> q0: ");
      Serial.print(q0);
      Serial.print(", q1: ");
      Serial.print(q1);
      Serial.print(", q2: ");
